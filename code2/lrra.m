...
iter = 0;
if display
    disp(['initial,rank=' num2str(rank(Z))]);    % num2str把数值转换成字符串， 转换后可以使用fprintf或disp函数进行输出
end
while iter<maxIter
    iter = iter + 1;
